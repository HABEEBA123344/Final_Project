...
app=Flask(__name__)
UPLOAD_FOLDER="E:/me_as/Documents/cancer_detection/web/static"
MODEL=None
DEVICE="cuda"
H = 224
W = 224
...
def ensemble_model(result_path,img):
    ...
    with CustomObjectScope({"Combo_loss": Combo_loss}):
      model1 = load_model('E:/me_as/Documents/cancer_detection/web/model1.h5', compile=False)
      model2 = load_model('E:/me_as/Documents/cancer_detection/web/model2.h5', compile=False)
      model3 = load_model('E:/me_as/Documents/cancer_detection/web/model3.h5', compile=False)
...
def upload_predict():
    if request.method=="POST":
        ...
        if image_file:
            ...
            result_path="E:/me_as/Documents/cancer_detection/web/static/ensemble"
